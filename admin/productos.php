    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="modificar.php" method="POST" enctype="multipart/form-data" autocomplete="off">
...
<script>
    function editar(id) {
        $.post('modificar.php', { id: id }, function(data) {
            ...
            $('input[name="p_normal"]').val(data.precio_normal);
            $('input[name="p_rebajado"]').val(data.precio_rebajado);
            $('input[name="cantidad"]').val(data.cantidad);
            $('input[name="foto"]').val(data.foto);
            $('#id').val(data.id);

            /*const modal = new bootstrap.Modal('#productos', {
                keyboard: false
            });
